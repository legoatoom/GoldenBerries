...
import com.github.legoatoom.goldenberries.registries.ItemRegistry;
...
public class GoldenBerryBushBlock extends SweetBerryBushBlock {
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ItemRegistry.GOLDEN_BERRIES);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            SweetBerryBushBlock.dropStack(world, pos, new ItemStack(ItemRegistry.GOLDEN_BERRIES, j + (isFullGrown ? 1 : 0)));
